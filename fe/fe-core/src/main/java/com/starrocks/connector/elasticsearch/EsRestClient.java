...
public class EsRestClient {
    ...
    private String sqlBasePath = "_sql";
    ...
    public void setDistribution(String distribution) {
        this.sqlBasePath = "opensearch".equals(distribution) ? "_plugins/_sql" : "_sql";
    }
    ...
    public List<EsSqlColumn> probeEsSqlSchema(String sqlQuery) throws StarRocksConnectorException {
        try {
            ...
            String response = executePost(sqlBasePath, requestBody.toString());
            ...
            JsonNode columnsNode = json.has("columns") ? json.get("columns") : json.get("schema");
            if (columnsNode != null) {
    ...
    private void closeEsSqlCursor(String cursor) throws StarRocksConnectorException {
        try {
            ...
            executePost(sqlBasePath + "/close", body.toString());
        } catch (Exception e) {
